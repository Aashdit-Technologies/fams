      ...
      <nav className="sidebar-nav">
        {menuItems.map((menu) => (
          <div key={menu.menuId} className="menu-item">
            <div
              className={`menu-title ${openMenus.menu === menu.menuId ? "active" : ""}`}
            ...
            >
              ...
              {menu.children?.length > 0 && !collapsed && (
                <span className="arrow-icon">
                  {openMenus.menu === menu.menuId ? <FaAngleDown /> : <FaChevronRight />}
                </span>
              )}
            </div>
            {menu.children?.length > 0 && openMenus.menu === menu.menuId && !collapsed && (
